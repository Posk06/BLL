...
#### Weiter Scripts
Diese Scripts ertsellen/steueren weiter Teile des Videospiels sind aber keiner Kategorie zuzuordnen
### Scenes
Diese Dateien enthalten den Aufbau der verschiedenen Welten die genutzt werden um das Spiel zusammenzubauen
### Prefabs
Diese Datein sind vorgefertigte Modelle welche im Spiel kreiert werden
### Misc_Data
Dieser Ordner enthält verschiedene Datein die helfen das Spiel zu bauen

## Dokumentation
Die Dokumentation dieses Projektes finden sie [hier](Project%20Dokumentation%20BLL%20Oskar%20Trillitzsch.pdf) und eine kurze Erklärung zu den verschiedenen Klassen finden sie [hier](generation-logic-short-eplanation.pdf).
