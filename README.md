...
## Dokumentation
Die Dokumentation dieses Projektes finden sie [hier](project-dokumentation-bll-oskar-trillitzsch.pdf) und eine kurze Erklärung zu den verschiedenen Klassen finden sie [hier](generation-logic-short-eplanation.pdf).
